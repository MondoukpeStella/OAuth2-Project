...
<body>
    <div class="flex min-h-screen items-center justify-center">
        <div class="relative h-[800px] w-[600px] overflow-hidden rounded-3xl">
            <div class="h-full w-full bg-[100%]"
                style="background-image: url('background.jpg');">
            </div>
            <div class="absolute bottom-0 flex h-3/4 w-full flex-col rounded-t-3xl shadow">
                <form class="space-y-8 px-10 py-10 text-center">
                    ...
                    <a href="#" class="inline-flex !w-auto justify-center font-medium text-white">Forgot
                        password?</a>
                </form>
                ...
                <a href="#"
                    ...
                    <span>
                        <svg class="h-5 w-5 fill-current text-white" viewBox="0 0 16 16" version="1.1"
                            aria-hidden="true">
